...
typedef enum
{
  ...
  eGPIO_Out_Gate_Set_low     = 0x3000,
  eGPIO_Out_Gate_Set_high    = 0x3004,
  eGPIO_Out_Gate_Reset_low   = 0x3008,
  eGPIO_Out_Gate_Reset_high  = 0x300c,
  eLVDS_Out_Gate_Set_low     = 0x4000,
  eLVDS_Out_Gate_Set_high    = 0x4004,
  eLVDS_Out_Gate_Reset_low   = 0x4008,
  eLVDS_Out_Gate_Reset_high  = 0x400c,
