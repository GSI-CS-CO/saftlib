...
typedef enum
{
  ...
  eGPIO_Gate_In_Set_low      = 0x1000,
  eGPIO_Gate_In_Set_high     = 0x1004,
  eGPIO_Gate_In_Reset_low    = 0x1008,
  eGPIO_Gate_In_Reset_high   = 0x100c,
  eLVDS_Gate_In_Set_low      = 0x2000,
  eLVDS_Gate_In_Set_high     = 0x2004,
  eLVDS_Gate_In_Reset_low    = 0x2008,
  eLVDS_Gate_In_Reset_high   = 0x200c,
  eGPIO_Gate_Out_Set_low     = 0x3000,
  eGPIO_Gate_Out_Set_high    = 0x3004,
  eGPIO_Gate_Out_Reset_low   = 0x3008,
  eGPIO_Gate_Out_Reset_high  = 0x300c,
  eLVDS_Gate_Out_Set_low     = 0x4000,
  eLVDS_Gate_Out_Set_high    = 0x4004,
  eLVDS_Gate_Out_Reset_low   = 0x4008,
  eLVDS_Gate_Out_Reset_high  = 0x400c,
