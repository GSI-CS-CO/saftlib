...
void Socket::wait_for_client()
{
  ...
  {
    std::cerr << "wait_for_client exception: " << e.what() << std::endl;
    throw;
  }
  ...
  std::cerr << "wait_for_client dt = " << dt << " us" << std::endl;          
