...
public:
  Allocator() {
    allocator_1 = new (::malloc(sizeof(ChunckAllocatorRT<16384, 128>)))
        ChunckAllocatorRT<16384, 128>;
    allocator_2 = new (::malloc(sizeof(ChunckAllocatorRT<128, 1024>)))
        ChunckAllocatorRT<128, 1024>;
    allocator_3 = new (::malloc(sizeof(ChunckAllocatorRT<64, 16384>)))
        ChunckAllocatorRT<64, 16384>;
  }
  ~Allocator() {
    ::free(allocator_3);
    ::free(allocator_2);
...
void *operator new(std::size_t n) { return get_allocator()->malloc(n); }
