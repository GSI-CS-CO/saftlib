...
public:
  ...
  FunctionGenerator( saftbus::Container*                    container,
  ...
  // static std::shared_ptr<FunctionGenerator> create(saftbus::Container *container, const std::string &object_path,
  // TimingReceiver *timing_receiver, std::shared_ptr<FunctionGeneratorImpl> impl);
  ...
  /// @param freq     Output sample frequency (0=16kHz, 1=32kHz, 2=64kHz, 3=125kHz, 4=250kHz, 5=500kHz, 6=1MHz, or
  /// 7=2MHz)
  ...
  ///
  // @saftbus-export
  bool AppendParameterSet( const std::vector<int16_t>&       coeff_a,
