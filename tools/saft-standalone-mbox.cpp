...
struct LM32testbench
    : public saftlib::OpenDevice
    , public saftlib::Mailbox
{
  ...
  {
    msi_irq_to_this_program =
        saftd.request_irq( *this, std::bind( &LM32testbench::receiveMSI, this, std::placeholders::_1 ) );
...
int main( int argc, char* argv[] )
{
  ...
  try
  {
    ...
    saftbus::Loop::get_default().connect<saftbus::TimeoutSource>( std::bind( &LM32testbench::triggerMSI, &testbench ),
