...
void ECA_TLU::configInput( unsigned channel, bool enable, uint64_t event, uint32_t stable )
{
  // OLD_DEBUG: std::cout << "ECA_TLU::configInput(channel=" << channel <<", enable=" << enable << ", event=" << event
  // << ", stable=" << stable << ")" << std::endl;
