...
static void injectSchedule(std::shared_ptr<TimingReceiver_Proxy> receiver, vector<Injection>& schedule, bool ppsAlign, bool verboseMode, int iterations, bool devInject);
...
int main(int argc, char** argv)
{
  ...
  try {
    ...
    injectSchedule(receiver, schedule, ppsAlign, verboseMode, nIter, devInject);
