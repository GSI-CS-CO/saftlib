...
#define ECA_TLU_STABLE_RW       0x0c // rw, 32 b, Signal must be high/low for stable cycles to be counted as a valid
                               // transition
#define ECA_TLU_EVENT_HI_RW 0x10 // rw, 32 b, Timing Event to generate (high word)
#define ECA_TLU_EVENT_LO_RW                                                                                            \
  0x14 // rw, 32 b, Timing Event to generate (low word), lowest bit is replaced with the edge of the transition
