#ifndef ANALYZE_JITTER_MSI_HPP_
#define ANALYZE_JITTER_MSI_HPP_
...
namespace saftlib {
	class AnalyzeJitterMSI : public TimingReceiverAddon
	{
		...
		bool send_msi_to_hw(uint32_t value);
	public:
		AnalyzeJitterMSI(saftlib::SAFTd *sd, saftlib::TimingReceiver *tr);
		~AnalyzeJitterMSI();
