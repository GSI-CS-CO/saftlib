...
static void io_help (void)
{
  ...
  std::cout << "                                        1 = configure the burst generator (switch to the 'configure' state)" << endl;
  std::cout << "                                        2 = start the operation (switch to the 'opready' state)" << endl;
  std::cout << "                                        3 = stop the operation (switch back to the 'configure' state)" << endl;
  std::cout << std::endl;
  ...
  std::cout << "      b_p, b_d, b_f                     Burst period (ns, 0=infinite), burst delay (ns), burst flag (0=new/overwrite, 1=append)" << std::endl;
  std::cout << "                                        IMPORTANT: minimum burst period is " << BG_BURST_PERIOD << " ns" << std::endl;
