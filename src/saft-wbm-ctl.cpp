...
static void wbm_help (void)
{
  ...
  std::cout << program << " exploder5a_123t " << "-c 0xffff000000000000 0xffffffffffffffff 0 3 -d"<< std::endl;
  std::cout << "  This will create a new condition targetet to macro at index 3 and disown it" << std::endl;
  std::cout << std::endl;
