...
foreach(SRC_FILE ${INPUT_FILES})
    ...
    list(APPEND SAFTLIB_GENERATED_FILES
        ${SAFTLIB_GENERATOR_DIR}/${BASENAME}_Service.cpp
        ${SAFTLIB_GENERATOR_DIR}/${BASENAME}_Service.hpp
        ${SAFTLIB_GENERATOR_DIR}/${BASENAME}_Proxy.cpp_saft
        ${SAFTLIB_GENERATOR_DIR}/${BASENAME}_Proxy.hpp
    )
    ...
    add_custom_command(
        ...
        COMMENT "SAFTLIB_GENERATOR_DIR: skdfjskdjflskdfj"
        COMMENT "SAFTLIB_GENERATOR_DIR: ${SAFTLIB_GENERATOR_DIR}"
    )

endforeach()

# Return the output files to caller
set(SAFTLIB_GENERATOR_DIR ${SAFTLIB_GENERATOR_DIR} PARENT_SCOPE)
